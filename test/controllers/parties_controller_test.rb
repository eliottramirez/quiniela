...
class PartiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create party" do
    assert_difference("Party.count") do
      post parties_url, params: { party: { name: @party.name, sharing_code: @party.sharing_code } }
    end
  ...
  test "should update party" do
    patch party_url(@party), params: { party: { name: @party.name, sharing_code: @party.sharing_code } }
